...
import { RevenueChartSkeleton, LatestInvoicesSkeleton, CardsSkeleton } from '@/app/ui/skeletons'; //ch 9 
...
//ch 9: remove fetchRevenue, fetchLatestInvoices , fetchCardData

export default async function Page() {
    //const revenue = await fetchRevenue(); remove in ch 9 for component streming 

    //const latestInvoices = await fetchLatestInvoices(); remove in ch 9 for component streming
    //const { numberOfInvoices, numberOfCustomers, totalPaidInvoices, totalPendingInvoices } = await fetchCardData(); remove in ch 9 for component streming

  return (
    <main>
        <h1 className = {`${lusitana.className} mb-4 text-xl md:text-2xl`}>Dashboard</h1>
        <div className='grid gap-6 sm:grid-cols-2 lg:grid-cols-4'>
            {/* modified for ch 9: wrap CardWrapper in Suspense for component streaming */}
