...
import { createInvoice, State } from '@/app/lib/actions'; //ch12 Form to create new invoice (step1)
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue=""
              //required
              aria-describery="customer-error"
            >
...
//ch14 
//Back in the create-form.tsx component, you can access the errors using the form state.
